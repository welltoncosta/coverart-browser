...
To make it work on Debian 12 (Bookworm), you need to add the stretch repository (as the necessary packages stopped at Buster Security). Don't worry, this tip has already been tested and it doesn't break the system.
